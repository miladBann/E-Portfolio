...
import Me from "../assets/black.png";
    ...
    <div id="resume" className="container">
      ...
      <div className="resume__wrapper">
        <div className="resume__grid" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            <div className="resume__name playfair">Milad Bannourah</div>
            <div className="resume__title lato">Software Engineer</div>
            <div className="resume__contact--info">
              <div>
                <FaDownload />
                <a className="resume__link" href={resume} >
                  Download resume
                </a>
              </div>
              <div>
                <MdEmail />
                <a className="resume__link" href="mailto:miladbannourah@outlook.com">
                  Email
                </a>
              </div>
              <div>
                ...
                <a
                  ...
                  href="https://www.linkedin.com/in/milad-bannourah/"
                  target="_blank"
                >
                  Linkedin
                </a>
            ...
            <div>
              ...
              further my programming passion as a Full-stack Web Developer.
            </div>
          </div>
        </div>
          ...
          <div>
            <div className="resume__education--wrapper">
              <div className="resume__education">
                ...
                <div>
                  Boot Camp Certificate, from Frontend Simplified
                </div>
              </div>
